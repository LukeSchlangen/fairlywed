...
// app.controller("AddressSearchBarController", function (PhotographerSearchFactory, PackagesFactory, $q) {
//     var self = this;
//     self.search = search;
...
//         var deferred = $q.defer();
//         if (address) {
//             self.gmapsService.getQueryPredictions({ input: address }, function (data) {
//                 deferred.resolve(data);
//             });
//         } else {
//             deferred.resolve()
